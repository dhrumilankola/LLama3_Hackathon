...
const ChatInterface = ({ insuranceType }) => {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const botMessage = { sender: 'bot', text: `You asked about ${insuranceType}. Here is some information.` };
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-r from-blue-400 to-indigo-600 text-white p-4">
      ...
      <div ref={chatContainerRef} className="flex-grow p-4 overflow-y-auto bg-white rounded-lg shadow-lg mb-4 max-h-80">
